...
\begin{titlepage}
    ...
    \begin{tikzpicture}[scale=1]
        ...
        \node[align=center,text width=10.2cm] at (0,-0.75) {\normalsize Version étudiante, claire et fidèle au projet implémenté};
    \end{tikzpicture}

    \vfill

    \begin{tabular}{rl}
        \textbf{Module :} & A compléter \\
        \textbf{Établissement :} & A compléter \\
        \textbf{Encadrant :} & A compléter \\
        \textbf{Auteurs :} & A compléter \\
        \textbf{Date :} & \today
    \end{tabular}
